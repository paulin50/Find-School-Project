<template>
    <div style="
      ...
      " class="jumbotron bg-cover text-white">
        <div class="container py-5 text-center">
            <h1 class="display-4 font-weight-bold">Conditions d'Utilisations</h1>
    ...
    <div class="container">
        ...
        <p>
        <h5>En vigueur au 04/06/2222</h5>
        </p>
        <p> Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique
            des modalités de mise à disposition du site et des services par GESCOLE et de définir les
            ...
            gescole.com se réserve le droit de modifier unilatéralement et à tout moment le contenu des
            présentes CGU.</p>


        <p>
        <h5>Article 1 : Les mentions légales</h5>
        </p>
        <p> L’édition et la direction de la publication de l'applications Findschola est assurée par it-innovation.
            Numéro de téléphone est 0000000000000000000 Adresse e-mail Findschola@gmail.com. L'hébergeur de l'applications
            Findschola est la société hebergeurfurtif, dont le siège social est situé au hebergeurfurtif, avec le
            numéro de téléphone : 0000000000000000000000000.</p>


        <p>
        <h5>ARTICLE 2 : Accès au site</h5>
        </p>
        <p>Le site gescole.com permet à l'Utilisateur un accès gratuit aux services suivants :
            ...
            notamment son adresse <br> 
            1Pour accéder aux services, l’Utilisateur doit ensuite s'identifier à l'aide de son identifiant et de son
            mot
            ...
            la responsabilité de gescole.com. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à
        ...
        <p>
        <h5> ARTICLE 3 : Collecte des données</h5>
        </p>
        <p>Le site assure à l'Utilisateur une collecte et un traitement d'informations personnelles dans le respect
            ...
            et aux libertés. Le site est déclaré à la CNIL sous le numéro 00000000000000000.
            ...
            exerce ce droit :
            · par mail à l'adresse email gescole@gescole.com
        </p>
        ...
        <p> Les marques, logos, signes ainsi que tous les contenus du site (textes, images, son…) font l'objet d'une
            protection par le Code de la propriété intellectuelle et plus particulièrement par le droit d'auteur. La
            marque FINDSCHOOLA est une marque déposée.Toute représentation et/ou reproduction et/ou exploitation partielle
            ou totale de cette marque, de quelque nature que ce soit, est totalement prohibée. L'Utilisateur doit
            solliciter l'autorisation préalable du site pour toute reproduction, publication, copie des différents
            contenus. Il s'engage à une utilisation des contenus du site dans un cadre strictement privé, toute
            utilisation à des fins commerciales et publicitaires est strictement interdite. Toute représentation totale
            ou partielle de ce site par quelque procédé que ce soit, sans l’autorisation expresse de l’exploitant du
            site Internet constituerait une contrefaçon sanctionnée par l’article L 335-2 et suivants du Code de la
            propriété intellectuelle. Il est rappelé conformément à l’article L122-5 du Code de propriété intellectuelle
            que l’Utilisateur qui reproduit, copie ou publie le contenu protégé doit citer l’auteur et sa source..</p>
    </div>
