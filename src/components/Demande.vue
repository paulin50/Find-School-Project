      ...
      <div class="row">
        <div class="col-4" >
          <div>
            ...
            <div>Sur Findschola.com, postez votre demande gratuitement et recevez les informations de nombreux établissements indépendants.</div><br>
            ...
            <div class="card-body">
                ...
                <div class="projcard-innerbox">
                  ...
                  <div class="projcard-textbox">
                    ...
                    <div class="projcard-tagbox">
                      <span class="projcard-tag">université</span>
                      <span class="projcard-tag">finance</span>
                      <span class="projcard-tag">Master</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="projcard projcard-red">
                <div class="projcard-innerbox">
                  ...
                  <div class="projcard-textbox">
                    ...
                    <div class="projcard-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
                    <div class="projcard-tagbox">
                      <span class="projcard-tag">Jardin</span>
                      <span class="projcard-tag">Totsi</span>
                      <span class="projcard-tag">5 ans d'experience</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="projcard projcard-green">
                <div class="projcard-innerbox">
                  ...
                  <div class="projcard-textbox">
                    ...
                    <div class="projcard-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
                    <div class="projcard-tagbox">
                      <span class="projcard-tag">Lycée</span>
                      <span class="projcard-tag">Enseignement technique</span>
                      <span class="projcard-tag">Classe G2</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="projcard projcard-customcolor" style="--projcard-color: #F5AF41;">
                <div class="projcard-innerbox">
                  ...
                  <div class="projcard-textbox">
                    <div class="projcard-title">Nouvelle bacheliére je recherche une école formant en gestion des projets TIC</div>
                    <div class="projcard-subtitle">Mlle Afi ABLAVI</div>
                    <div class="projcard-bar"></div>
                    <div class="projcard-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
                    <div class="projcard-tagbox">
                      <span class="projcard-tag">Gestion</span>
                      <span class="projcard-tag">Technologie</span>
                      <span class="projcard-tag">Informatique</span>
                    </div>
                  </div>
                </div>
              </div>
