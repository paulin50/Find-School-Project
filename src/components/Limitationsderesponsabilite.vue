<template>
    <div style="
      ...
      " class="jumbotron bg-cover text-white">
        <div class="container py-5 text-center">
            <h1 class="display-4 font-weight-bold">Limitations de responsabilité</h1>
    ...
    <div class="container">
        ...
        <p> L’édition et la direction de la publication de l'applications Findschola est assurée par it-innovation.
            Numéro de téléphone est 0000000000000000000 Adresse e-mail Findschola@gmail.com. L'hébergeur de
            l'applications
        ...
        <p> Les marques, logos, signes ainsi que tous les contenus du site (textes, images, son…) font l'objet d'une
            ...
            marque FINDSCHOOLA est une marque déposée.Toute représentation et/ou reproduction et/ou exploitation
            partielle
